export default function DeathStarPattern({ width = 80, height = 105, fill = '#000' }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 80 105">
      <g fillRule="evenodd">
        <g id="death-star" fill={fill}>
